...
mucosal_data_meta$Subset <- dplyr::recode(mucosal_data_meta$Subset,Mucosal_Colon = "Colon Mucosa")

### Make and store plots ---
adiv_trios_shannon<- generate_adiv_plots(data_meta, Genotype, shannon_entropy, 0, 8) +
  facet_wrap(~Subset)+
  labs(x="",y="shannon")+
  ggtitle("2 month-old")+
...
adiv_trios_otus<- generate_adiv_plots(data_meta, Genotype, observed_features, 0, 600) +
  facet_wrap(~Subset)+
  labs(x="",y="# ASVs")+
  ggtitle("2 month-old")+
  theme(plot.title = element_text(hjust = 0.5))
...
mc_adiv_trios_shannon<- generate_adiv_plots(mucosal_data_meta, Genotype, shannon_entropy, 0, 8) +
  facet_wrap(~Subset)+
  labs(x="",y="shannon")+
  ggtitle("2 month-old")+
  theme(plot.title = element_text(hjust = 0.5))
...
mc_adiv_trios_otus<- generate_adiv_plots(mucosal_data_meta, Genotype, observed_features, 0, 600) +
  facet_wrap(~Subset)+
  labs(x="",y="# ASVs")+
  ggtitle("2 month-old")+
  theme(plot.title = element_text(hjust = 0.5))
...
adiv_slt_shannon<- generate_adiv_plots(data_meta, Genotype, shannon_entropy, 0, 8) +
...
adiv_slt_otus<- generate_adiv_plots(data_meta, Genotype, observed_features, 0, 600) +
  #stat_compare_means(comparisons = compare,method="wilcox", vjust=0.3,label="p.signif",step.increase=0.05)+
  facet_wrap(~Subset)+
  labs(x="",y="# ASVs")+
  ggtitle("12 month-old")+
...
mc_adiv_slt_shannon<- generate_adiv_plots(mucosal_data_meta, Genotype, shannon_entropy, 0, 8) +
  facet_wrap(~Subset)+
  labs(x="",y="shannon")+
  ggtitle("12 month-old")+
  theme(plot.title = element_text(hjust = 0.5))
...
mc_adiv_slt_otus<- generate_adiv_plots(mucosal_data_meta, Genotype, observed_features, 0, 600) +
  facet_wrap(~Subset)+
  labs(x="",y="# ASVs")+
  ggtitle("12 month-old")+
  theme(plot.title = element_text(hjust = 0.5))

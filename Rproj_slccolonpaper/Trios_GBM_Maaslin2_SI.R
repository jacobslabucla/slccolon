...
pathway <- read.delim("Trios/Trios_OMIXER/GBM/modules.tsv", header = TRUE, row.names=1)
...
data<-read.table("Trios/Trios_OMIXER/GBM/PICRUST2_PWY_Mucosal_SI_Maaslin2_SequencingRun_Site_Sex_Genotype_1-MouseID/significant_results.tsv", header=TRUE)

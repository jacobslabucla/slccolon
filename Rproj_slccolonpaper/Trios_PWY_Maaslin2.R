...
fit_data = Maaslin2(input_data=df_input_data, 
                    ...
                    output = paste0("Trios/differential_Pathway/PICRUST2_PWY_Luminal_Colon_Maaslin2_Site_Sex_Genotype_1-Litter_1-MouseID"), 
...
fit_data = Maaslin2(input_data=df_input_data, 
                    input_metadata=df_input_metadata, 
                    output = paste0("Trios/differential_Pathway/PICRUST2_PWY_Luminal_Colon_Maaslin2_Site_Sex_Genotype_1-MouseID"), 
                    fixed_effects = c("Site",  "Sex", "Genotype"), normalization = "TSS", 
...
fit_data = Maaslin2(input_data=df_input_data, 
                    input_metadata=df_input_metadata, 
                    output = paste0("Trios/differential_Pathway/PICRUST2_PWY_Mucosal_Colon_Maaslin2_Site_Sex_Genotype_1-Litter_1-MouseID"), 
                    fixed_effects = c("Site",  "Sex", "Genotype"), normalization = "TSS", 
                    random_effects = c("Litter","MouseID"),
                    #reference = c("Genotype,WT", "Site,Distal_Colon"),
                    min_prevalence = 0.15,
...
fit_data = Maaslin2(input_data=df_input_data, 
                    input_metadata=df_input_metadata, 
                    output = paste0("Trios/differential_Pathway/PICRUST2_PWY_Mucosal_Colon_Maaslin2_Site_Sex_Genotype_1-MouseID"), 
                    fixed_effects = c("Site",  "Sex", "Genotype"), normalization = "TSS", 
                    random_effects = c("MouseID"),
                    #reference = c("Genotype,WT", "Site,Distal_Colon"),
                    min_prevalence = 0.15,
